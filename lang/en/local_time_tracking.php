...
$string['summarycoursetime'] = 'Time spent in course (view, gradebook, etc): {$a->time}';
$string['summarymoduletime'] = 'Time spent in activities: {$a->time}';
$string['summarytotaltime'] = '<b>Total time</b>: {$a->time}';
$string['time'] = 'Time';
